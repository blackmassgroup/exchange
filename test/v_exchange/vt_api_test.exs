defmodule VExchange.VtApiTest do
  ...
  describe "vt_api_requests" do
    ...
    test "create_vt_api_request/1 with valid data creates a vt_api_request" do
      valid_attrs = %{raw_request: "some raw_request", raw_response: "some raw_response", http_response_code: 42}
    ...
    test "update_vt_api_request/2 with valid data updates the vt_api_request" do
      vt_api_request = vt_api_request_fixture()
      update_attrs = %{raw_request: "some updated raw_request", raw_response: "some updated raw_response", http_response_code: 43}

      assert {:ok, %VtApiRequest{} = vt_api_request} = VtApi.update_vt_api_request(vt_api_request, update_attrs)
    ...
    test "update_vt_api_request/2 with invalid data returns error changeset" do
      vt_api_request = vt_api_request_fixture()
      assert {:error, %Ecto.Changeset{}} = VtApi.update_vt_api_request(vt_api_request, @invalid_attrs)

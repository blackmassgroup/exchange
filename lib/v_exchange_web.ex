defmodule VExchangeWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: VExchangeWeb.Layouts]
  ...
  defp html_helpers do
    quote do
      ...
      import VExchangeWeb.CoreComponents
      import VExchangeWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: VExchangeWeb.Router,
        statics: VExchangeWeb.static_paths()
    end
  end

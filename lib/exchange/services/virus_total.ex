defmodule Exchange.Services.VirusTotal do
  @moduledoc """
  ...
  Gets a VirusTotal sample by SHA256.
    ...
    ## Example
        iex> Exchange.Services.VirusTotal.get_sample("1234567890")
        {:ok, %{}}
  """
  ...
  ## Example
      iex> Exchange.Services.VirusTotal.post_comment("https://www.virustotal.com/gui/file/.../detection", "This file seems suspicious")
      {:ok, %{"data" => ...}}
  """
  ...
  Example:
  ```
  {:ok, analysis} = Exchange.Services.VirusTotal.get_analysis("1234567890")
  ```
  """

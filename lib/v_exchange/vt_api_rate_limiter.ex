defmodule VExchange.VtApiRateLimiter do
  ...
  Example usage:
  ```
  {:ok, vt_api_rate_limiter} = VExchange.VtApiRateLimiter.start_link(1700)
  VExchange.VtApiRateLimiter.allow_request(vt_api_rate_limiter, 0)
  VExchange.VtApiRateLimiter.allow_request(vt_api_rate_limiter, 1)
  VExchange.VtApiRateLimiter.allow_request(vt_api_rate_limiter, 2)
  VExchange.VtApiRateLimiter.allow_request(vt_api_rate_limiter, 3)
  ```
  """
  use GenServer
  require Logger

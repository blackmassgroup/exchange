defmodule ExchangeWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ExchangeWeb.Gettext
  ...
  def input(%{type: "permissions"} = assigns) do
    all_permissions = Exchange.Accounts.DefaultRoles.all() |> hd() |> Map.get(:permissions)

defmodule VxUndergroundWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VxUndergroundWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VxUndergroundWeb.Gettext, "errors", msg, opts)
    end
  end

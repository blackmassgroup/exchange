defmodule VExchangeWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "permissions"} = assigns) do
    all_permissions = VExchange.Accounts.DefaultRoles.all() |> hd() |> Map.get(:permissions)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VExchangeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VExchangeWeb.Gettext, "errors", msg, opts)
    end
  end
